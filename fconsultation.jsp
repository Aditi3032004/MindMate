...
<body>
    ...
    <div class="doctor-container">
        <img src="fdr1.webp" alt="Dr. Arjun Malhotra">
        <h2>Dr. Arjun Malhotra</h2>
        <p><strong>Specialization:</strong> Financial Stress & Anxiety Counseling</p>
        <p>Dr. Arjun Malhotra is a financial stress counselor with 12 years of experience. He helps individuals manage anxiety caused by financial instability, offering cognitive behavioral therapy (CBT) and practical coping strategies.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="fdr2.webp" alt="Dr. Rohan Verma">
        <h2>Dr. Neha Desai</h2>
        <p><strong>Specialization:</strong> Stress Management & Financial Wellness</p>
        <p>Dr. Neha Desai is an expert in financial wellness and stress management. With over 10 years of experience, she provides guidance on overcoming financial anxiety through mindfulness, therapy, and structured financial planning techniques.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="fdr3.webp" alt="Dr. Meera Kapoor">
        <h2>Dr. Karan Mehta</h2>
        <p><strong>Specialization:</strong> Emotional Resilience & Financial Stress</p>
        <p>Dr. Karan Mehta has 8 years of experience helping clients build emotional resilience against financial stress. He combines psychotherapy with personalized financial stress management plans to promote mental well-being.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    </div>
