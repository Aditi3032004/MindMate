...
<head>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const quizData = [
                {
                    question: "What do you feel is the level of your financial stress today?",
                    options: [
                        "No stress at all",
                        "Low stress",
                        "High stress",
                ...
                {
                    question: "How often does this happen to you? You want to go out to eat, go to a movie or do something else and don’t go because you can’t afford to?",
                    options: [
                        "No stress at all",
                        "Low stress",
                        "High stress",
                ...
                {
                    question: "How frequently do you find yourself just getting by financially and living paycheck to paycheck?",
                    options: [
                        "No stress at all",
                        "Low stress",
                        "High stress",
            ...
            submitBtn.addEventListener("click", () => {
                ...
                if (selectedOptionIndex !== -1) {
                    ...
                    score += selectedAnswer === 'Overwhelming stress' ? 20 : selectedAnswer === 'High stress' ? 15 : selectedAnswer === 'Low stress' ? 10 : 0;
                    ...
                    if (currentQuiz < quizData.length) {
                        ...
                        window.location.href = `fresult.jsp?score=${percentage}`; // Redirect to result page with score
                    }
                } else {
