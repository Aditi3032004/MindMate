...
<body>
    ...
    <div class="doctor-container">
        <img src="dr1.webp" alt="Dr. Aisha Sharma">
        <h2>Dr. Aisha Sharma</h2>
        <p><strong>Specialization:</strong> Anxiety & Stress Management</p>
        <p>Dr. Aisha Sharma is a certified psychologist with 10 years of experience in anxiety management. She provides personalized treatment plans to help individuals overcome stress and anxiety effectively.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="dr3.webp" alt="Dr. Rohan Verma">
        <h2>Dr. Rohan Verma</h2>
        <p><strong>Specialization:</strong> Anxiety & Cognitive Behavioral Therapy</p>
        <p>Dr. Rohan Verma has 8 years of experience in treating anxiety disorders using cognitive behavioral therapy (CBT). His sessions focus on practical strategies to manage anxiety effectively.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="dr2.webp" alt="Dr. Meera Kapoor">
        <h2>Dr. Meera Kapoor</h2>
        <p><strong>Specialization:</strong> Anxiety & Panic Attack Management</p>
        <p>Dr. Meera Kapoor is an anxiety specialist with over 12 years of experience. She helps patients overcome panic attacks and chronic stress through mindfulness-based therapy.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    </div>
