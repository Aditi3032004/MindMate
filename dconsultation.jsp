...
<head>
    ...
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
        ...
        <style>
			...
			.navbar1{height: 75px; padding-top: 20px; display: flex; justify-content: end; align-items: center; font-family: "open Sans", sans-serif; padding-right: 15px; padding-left: 15px; border-bottom: solid 3px #F4BB44;}
...
.doctor-container {
    ...
    margin-bottom: 5px;
        ...
        .doctor-container h2 {
    font-size: 25px; /* Doctor ka naam bada karne ke liye */
    font-weight: bold;
    margin-bottom: 5px;
}

.doctor-container p {
    font-size: 18px; /* Description text ke liye */
    white-space: normal;
...
<body>
    ...
    <div class="doctors-container">
        <div class="doctor-container">
            <img src="ddr1.webp" alt="Dr. Rahul Mehta">
            <h2>Dr. Rahul Mehta</h2>
            <p><strong>Specialization:</strong> Depression & Mood Disorders</p>
            <p>Dr. Rahul Mehta is a highly experienced mental health professional specializing in Depression & Mood Disorders. With over 15 years of expertise, he has helped countless patients manage and overcome the challenges of depression.</p>
            <button>Book Consultation</button>
        </div>
        <div class="doctor-container">
            <img src="ddr2.webp" alt="Dr. Ananya Roy">
            <h2>Dr. Ananya Roy</h2>
            <p><strong>Specialization:</strong> Clinical Depression & Therapy</p>
            <p>Dr. Ananya Roy is a dedicated mental health specialist with extensive experience in treating clinical depression. She provides personalized therapy tailored to the unique needs of each individual, ensuring a compassionate and effective approach to mental well-being.</p>
            <button>Book Consultation</button>
        </div>
        <div class="doctor-container">
            <img src="ddr3.webp" alt="Dr. Vikram Singh">
            <h2>Dr. Vikram Singh</h2>
            <p><strong>Specialization:</strong> Depression & Emotional Well-being</p>
            <p>Dr. Vikram Singh is a skilled mental health professional specializing in Depression & Emotional Well-being. With 10 years of experience, he helps individuals overcome depression using holistic approaches, combining therapy, lifestyle changes, mindfulness, and stress management.</p>
            <button>Book Consultation</button>
        </div>
    </div>
