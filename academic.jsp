        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            submitBtn.addEventListener("click", () => {
                ...
                if (selectedOptionIndex !== -1) {
                    ...
                    score += selectedAnswer === 'Strongly agree' ? 25 : selectedAnswer === 'Neither agree or disagree' ? 15 : selectedAnswer === 'Strongly disagree' ? 10 : 0;
                    ...
                    if (currentQuiz < quizData.length) {
                        ...
                        window.location.href = `acresult.jsp?score=${percentage}`; // Redirect to result page with score
                    }
                } else {
