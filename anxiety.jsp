        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const calculateScore = (answers) => {
                for (let i = 0; i < answers.length; i++) {
                    if (answers[i] === 'Nearly every day') {
                        score += 20; // Example: gives 20 points for this answer
                    } else if (answers[i] === 'Several days') {
                        score += 15; // Example: gives 10 points for this answer
                    } else if (answers[i] === 'More than half the days') {
            ...
            submitBtn.addEventListener("click", () => {
                ...
                if (selectedOptionIndex !== -1) {
                    ...
                    score += selectedAnswer === 'Nearly every day' ? 20 : selectedAnswer === 'Several days' ? 15 : selectedAnswer === 'More than half the days' ? 10 : 0;
                    ...
                    if (currentQuiz < quizData.length) {
                        ...
                        window.location.href = `aresult.jsp?score=${percentage}`; // Redirect to result page with score
                    }
                } else {
